Playwright - Se pueden ver las pruebas en la carpeta tests y la configuración correspondiente en el archivo playwirght.config.ts

Python - Manejo de condicionales, loops, y manejo de arrays con texto en los archivos ex_05_02.py y ex_08_04.py
